...
import { featuredProjectsQuery, featuredPostsQuery, aboutQuery } from "@/lib/sanity/queries"
import { safeFetch } from "@/lib/sanity/error-handling"
import HomeClientContent from "./home-client-content"

export default async function HomePage() {
  // Fetch featured projects, posts, and about data from Sanity with error handling
  ...
  return <HomeClientContent featuredProjects={featuredProjects} featuredPosts={featuredPosts} aboutData={aboutData} />
}